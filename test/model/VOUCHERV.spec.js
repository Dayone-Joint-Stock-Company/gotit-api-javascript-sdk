...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SampleApi.VOUCHERV();
  });
  ...
  describe('VOUCHERV', function() {
    it('should create an instance of VOUCHERV', function() {
      // uncomment below and update the code to test VOUCHERV
      //var instance = new SampleApi.VOUCHERV();
      //expect(instance).to.be.a(SampleApi.VOUCHERV);
    });
