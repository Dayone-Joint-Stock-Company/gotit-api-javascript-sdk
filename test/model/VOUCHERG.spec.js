...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SampleApi.VOUCHERG();
  });
  ...
  describe('VOUCHERG', function() {
    it('should create an instance of VOUCHERG', function() {
      // uncomment below and update the code to test VOUCHERG
      //var instance = new SampleApi.VOUCHERG();
      //expect(instance).to.be.a(SampleApi.VOUCHERG);
    });
