...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SampleApi.BRANDDETAIL();
  });
  ...
  describe('BRANDDETAIL', function() {
    it('should create an instance of BRANDDETAIL', function() {
      // uncomment below and update the code to test BRANDDETAIL
      //var instance = new SampleApi.BRANDDETAIL();
      //expect(instance).to.be.a(SampleApi.BRANDDETAIL);
    });
    ...
    it('should have the property brandAddr (base name: "brandAddr")', function() {
      // uncomment below and update the code to test the property brandAddr
      //var instance = new SampleApi.BRANDDETAIL();
      //expect(instance).to.be();
    });
