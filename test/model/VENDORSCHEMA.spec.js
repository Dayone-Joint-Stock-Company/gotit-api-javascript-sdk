...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SampleApi.VENDORSCHEMA();
  });
  ...
  describe('VENDORSCHEMA', function() {
    it('should create an instance of VENDORSCHEMA', function() {
      // uncomment below and update the code to test VENDORSCHEMA
      //var instance = new SampleApi.VENDORSCHEMA();
      //expect(instance).to.be.a(SampleApi.VENDORSCHEMA);
    });
