...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SampleApi.PRODUCTG();
  });
  ...
  describe('PRODUCTG', function() {
    it('should create an instance of PRODUCTG', function() {
      // uncomment below and update the code to test PRODUCTG
      //var instance = new SampleApi.PRODUCTG();
      //expect(instance).to.be.a(SampleApi.PRODUCTG);
    });
