...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SampleApi.VOUCHERVSCHEMAVouchers();
  });
  ...
  describe('VOUCHERVSCHEMAVouchers', function() {
    it('should create an instance of VOUCHERVSCHEMAVouchers', function() {
      // uncomment below and update the code to test VOUCHERVSCHEMAVouchers
      //var instance = new SampleApi.VOUCHERVSCHEMAVouchers();
      //expect(instance).to.be.a(SampleApi.VOUCHERVSCHEMAVouchers);
    });
