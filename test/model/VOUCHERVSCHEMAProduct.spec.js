...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SampleApi.VOUCHERVSCHEMAProduct();
  });
  ...
  describe('VOUCHERVSCHEMAProduct', function() {
    it('should create an instance of VOUCHERVSCHEMAProduct', function() {
      // uncomment below and update the code to test VOUCHERVSCHEMAProduct
      //var instance = new SampleApi.VOUCHERVSCHEMAProduct();
      //expect(instance).to.be.a(SampleApi.VOUCHERVSCHEMAProduct);
    });
