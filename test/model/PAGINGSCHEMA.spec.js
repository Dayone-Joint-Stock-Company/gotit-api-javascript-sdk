...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SampleApi.PAGINGSCHEMA();
  });
  ...
  describe('PAGINGSCHEMA', function() {
    it('should create an instance of PAGINGSCHEMA', function() {
      // uncomment below and update the code to test PAGINGSCHEMA
      //var instance = new SampleApi.PAGINGSCHEMA();
      //expect(instance).to.be.a(SampleApi.PAGINGSCHEMA);
    });
