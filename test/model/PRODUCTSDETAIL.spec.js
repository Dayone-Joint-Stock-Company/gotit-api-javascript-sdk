...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SampleApi.PRODUCTSDETAIL();
  });
  ...
  describe('PRODUCTSDETAIL', function() {
    it('should create an instance of PRODUCTSDETAIL', function() {
      // uncomment below and update the code to test PRODUCTSDETAIL
      //var instance = new SampleApi.PRODUCTSDETAIL();
      //expect(instance).to.be.a(SampleApi.PRODUCTSDETAIL);
    });
