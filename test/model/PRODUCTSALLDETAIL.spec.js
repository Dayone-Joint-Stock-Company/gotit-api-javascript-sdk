...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SampleApi.PRODUCTSALLDETAIL();
  });
  ...
  describe('PRODUCTSALLDETAIL', function() {
    it('should create an instance of PRODUCTSALLDETAIL', function() {
      // uncomment below and update the code to test PRODUCTSALLDETAIL
      //var instance = new SampleApi.PRODUCTSALLDETAIL();
      //expect(instance).to.be.a(SampleApi.PRODUCTSALLDETAIL);
    });
