    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [PRODUCTDETAIL]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                PRODUCTDETAIL.validateJSON(item);
            };
        }
 ...
 */
PRODUCTDETAILRESPONSE.prototype['status'] = undefined;

/**
 * HTTP response status codes
 * @member {Number} statusCode
 */
PRODUCTDETAILRESPONSE.prototype['statusCode'] = undefined;

/**
 * Error code
 * @member {String} error
 */
PRODUCTDETAILRESPONSE.prototype['error'] = undefined;

/**
 * Message Error
 * @member {String} message
 */
PRODUCTDETAILRESPONSE.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/PRODUCTDETAIL>} data
 */
PRODUCTDETAILRESPONSE.prototype['data'] = undefined;
