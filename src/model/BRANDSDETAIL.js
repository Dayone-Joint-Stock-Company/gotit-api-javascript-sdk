...
/**
 * The BRANDSDETAIL model module.
 * @module model/BRANDSDETAIL
 * @version 4.0.0
 */
class BRANDSDETAIL {
    /**
     * Constructs a new <code>BRANDSDETAIL</code>.
     * @alias module:model/BRANDSDETAIL
     */
    constructor() { 
        
        BRANDSDETAIL.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BRANDSDETAIL</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BRANDSDETAIL} obj Optional instance to populate.
     * @return {module:model/BRANDSDETAIL} The populated <code>BRANDSDETAIL</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BRANDSDETAIL();
            ...
            if (data.hasOwnProperty('shortDesc')) {
                obj['shortDesc'] = ApiClient.convertToType(data['shortDesc'], Object);
            }
            ...
            if (data.hasOwnProperty('serviceGuide')) {
                obj['serviceGuide'] = ApiClient.convertToType(data['serviceGuide'], Object);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BRANDSDETAIL</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BRANDSDETAIL</code>.
     */
 ...
 */
BRANDSDETAIL.prototype['brandId'] = undefined;

/**
 * Brand name
 * @member {String} brandNm
 */
BRANDSDETAIL.prototype['brandNm'] = undefined;

/**
 * Link to brand logo image
 * @member {String} brandLogo
 */
BRANDSDETAIL.prototype['brandLogo'] = undefined;

/**
 * Brand name used for URL
 * @member {String} slug
 */
BRANDSDETAIL.prototype['slug'] = undefined;

/**
 * Brand short description
 * @member {Object} shortDesc
 */
BRANDSDETAIL.prototype['shortDesc'] = undefined;

/**
 * @member {String} description
 */
BRANDSDETAIL.prototype['description'] = undefined;

/**
 * Array containing a list of Categories codes to which the Brand belongs
 * @member {Array.<Object>} categoryID
 */
BRANDSDETAIL.prototype['categoryID'] = undefined;

/**
 * The serial number displays the brand
 * @member {Number} order
 */
BRANDSDETAIL.prototype['order'] = undefined;

/**
 * Describe the brand's terms of reference (T&C). HTML format
 * @member {Object} serviceGuide
 */
BRANDSDETAIL.prototype['serviceGuide'] = undefined;

/**
 * @member {Array.<module:model/STORESSCHEMA>} stores
 */
BRANDSDETAIL.prototype['stores'] = undefined;

/**
 * Information on the brand's applicable channels
 * @member {Array.<module:model/USAGEMETHODSCHEMA>} usageMethods
 */
BRANDSDETAIL.prototype['usageMethods'] = undefined;
